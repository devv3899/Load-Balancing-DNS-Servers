...
print('[TS1]: Running on port:', port)
...
# This method loads the given DNS table file in a dictionary
# where the key is lowercase hostname
def loadDNSTable(fileName):
	...
	try:
		...
		printRightNow('[TS1]: Filesystem error in opening ' + fileName);
...
def clientHandler(c):
	...
	printRightNow('[TS1]: Processing request: ' + request)
...
def main():
	...
	try:
		...
		printRightNow("[TS1]: TS Server socket created")
	except socket.error as err:
		printRightNow('[TS1]: socket open error: {}\n'.format(err))
		exit()
